...
<script type="text/javascript" src="<?=ASSETS?>BeautyE-commerce/js/responsee.js"></script>
<script type="text/javascript" src="<?=ASSETS?>BeautyE-commerce/js/jquery.events.touch.js"></script>
<script type="text/javascript" src="<?=ASSETS?>BeautyE-commerce/owl-carousel/owl.carousel.js"></script>
<script type="text/javascript" src="<?=ASSETS?>BeautyE-commerce/js/template-scripts.js"></script>
</body>
</html>
